...
📸 [SCREENSHOT ATTACHMENT]: Insert Image 5706383a... here (Shows Load Balancer components and SG setup).
...
* Cost Efficiency: For the initial launch (MVP), I verified that the ASG could successfully provision instances `Ideal-Staff`, then scaled them back to minimize idle resource costs.

📸 [SCREENSHOT ATTACHMENT]: Insert Image 62c2ea5e... here (Shows the Auto Scaling Group launching 'Ideal-Staff' instances).
